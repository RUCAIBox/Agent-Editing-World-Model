...
def _load_config(args: argparse.Namespace):
    ...
    # --data-file must win deterministically. A config override beats the yaml
    # ${DATA_FILE} expansion (loader applies overrides after env), so a pre-set
    # DATA_FILE env can no longer silently shadow the CLI arg.
